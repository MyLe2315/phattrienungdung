    ...
    <div class="main">
        ...
        <div class="container-fluid">
            <div class="row border" style="height:auto;">
                <div class="col-2 border-right" style="height: 457px;">
                        ...
                        <div class="row border-bottom ">
                            <div class="col-5 ">
                                <div class="panel-he ading text-primary">
                                    <h5 style="margin-top: 5px;"> Đề thi môn:

                                        <?php
                                        $layid_mh = $_REQUEST['idmonhoc'];
                                        if ($layid_mh != '') {

                                            $m->load_monhoc("select * from monhoc where idmonhoc='$layid_mh' order by idmonhoc asc limit 1");
                                        }
                                    ...
                                    <p>
                                        ...
                                        <?php
                                            ...
                                            $m->load_thoigian("select id,thoigian from detracnghiem  order by kythi asc limit 1");
